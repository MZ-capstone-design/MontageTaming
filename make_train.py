...
image_cropped_path = "/opt/ml/DALLE-Couture/data/cropped_img"
...
with open("/opt/ml/taming-transformers/data/train.txt", "w", encoding="utf-8") as f:
...
with open("/opt/ml/taming-transformers/data/test.txt", "w", encoding="utf-8") as f:
